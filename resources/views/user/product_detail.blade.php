...
-->
    ...
    <link rel="stylesheet" href="{{asset('ssets/css/owl.css')}}a">
  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="{{url('/')}}"><h2>EShop <em>Clothing</em></h2></a>
    ...
    <div class="" style="padding: 100px;">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                <img class="detail-img" width="400px" height="400px" src="{{asset('public/productimage/'.$product->image)}}" alt="">
                </div>
                <div class="col-sm-6">
                    <button class="btn btn-warning"><a style="color:white;" href="/">← Go Back</a></button>
                    <br><br>
